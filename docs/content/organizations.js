const source = [
  ...
  {
    'name': '24.02fund. Фонд термінової підтримки для журналістів та громадян',
    'tags': [
      'ЗМІ',
      'Недержавні'
    ],
    'description': 'Ми – спільнота журналістів, фотографів, операторів, редакторів, які працюють в Україні – започаткували фонд «24.02» для допомоги в оснащенні репортерів та редакцій необхідним обладнанням та засобами захисту.',
    'link': 'https://2402.org/ua/',
    'donateLink': 'https://2402.org/ua/#donate',
