...
**Glory to Ukraine!**
    `,
    description: 'There has not been a single day since the blockade of Mariupol that we have not sought a solution. Military or diplomatic – anything to save people. But finding this solution is extremely difficult.',
    url: 'https://www.youtube.com/watch?v=NeobYTXX4OQ'
  },
  {
    id: 'NeobYTXX4OQ',
    name: 'President Volodymyr Zelenskyi spoke with Ukrainian journalists',
    translated: false,
    russianTimestamp: '',
    speaker: ['Володимир Зеленський'],
    ...
    cities: ['Маріуполь'],
    text: `
Today, President Volodymyr Zelenskyi spoke with journalists from Ukrayinska Pravda, Livy Bereg, LIGA.net, RBC-Ukraine, Obozrevatel and Ukrinform.
    `,
    description: 'Today, President Volodymyr Zelenskyi spoke with journalists from Ukrayinska Pravda, Livy Bereg, LIGA.net, RBC-Ukraine, Obozrevatel and Ukrinform.',
    url: 'https://www.youtube.com/watch?v=NeobYTXX4OQ'
  },
  {
    id: 'xtzFZFUNR_o',
    name: 'Summary briefing on the results of the work created by the President of the Humanitarian Staff',
    translated: false,
    russianTimestamp: '',
    ...
    text: `
Andriy Yermak: "Ukraine is grateful for the help of world celebrities and all concerned citizens of different countries". Summary briefing on the results of the work created by the President of the Humanitarian Staff
    `,
    description: 'Andriy Yermak: "Ukraine is grateful for the help of world celebrities and all concerned citizens of different countries."',
...
**Glory to Ukraine!**
  ...
  {
    id: 'RiyyHsmOKYA',
    name: 'Iryna Vereshchuk talks about the results of the work of humanitarian corridors on April 7',
    translated: false,
    russianTimestamp: '',
    speaker: ['Ірина Верещук'],
    ...
    topics: ['Гуманітарні коридори'],
    cities: [],
    text: `Iryna Vereshchuk talks about the results of the work of humanitarian corridors on April 7`,
    description: 'Iryna Vereshchuk talks about the results of the work of humanitarian corridors on April 7',
...
**Glory to Ukrainians and glory to Ukraine!**
  ...
  {
    id: 'Yf1ifcL_UJc',
    name: 'Speech by the President of Ukraine in the House of Representatives of Cyprus',
    translated: false,
    russianTimestamp: '',
    speaker: ['Володимир Зеленський'],
    ...
    text: `
**Dear Mr. President of the Republic of Cyprus!**

**Dear Mrs. President of the House of Representatives!**
...
**Glory to Ukraine!**
    `,
    description: 'It is now being decided whether we will preserve the unity of our territory and our state. Whether we will guarantee freedom for Ukraine and for the whole of Europe. For different countries where Russian troops can go after Ukraine.',
    url: 'https://www.youtube.com/watch?v=Yf1ifcL_UJc'
  },
  {
    id: 'RElJwwilgXU',
    name: 'Speech by President of Ukraine Volodymyr Zelenskyy in the Parliament of Greece',
    translated: false,
    russianTimestamp: '',
    speaker: ['Володимир Зеленський'],
...
**Glory to Ukraine!**
    `,
    description: 'I believe that Ukraine and Greece will soon live on an equal footing in our common European home, the European Union. I believe in this! I know it!',
...
**Glory to Ukraine!**
    `,
    description: 'We are already doing everything possible to identify all the Russian military involved in these crimes as soon as possible. Everything to punish them.',
...
**Glory to Ukrainians! Glory to Ukraine!**
  ...
  {
    id: 'LX-EOwXvUos',
    name: 'It is time to do everything to make the war crimes of the Russian military the last manifestation of this evil on earth',
    translated: true,
...
**Glory to Ukraine!**
    `,
    description: 'The world has already seen many war crimes. At different times. On different continents. But it is time to do everything possible to make the war crimes of the Russian military the last manifestation of such evil on earth.',
