const source = [
  {
    id: 'nQDtSl-l_d8',
    name: 'Сьогодні – Прощена неділя. Але ми не пробачимо сотні й сотні жертв',
    translated: false,
    russianTimestamp: '',
    ...
    text: `«Сьогодні – Прощена неділя. Але ми не пробачимо сотні й сотні жертв. Тисячі й тисячі страждань. І Бог не пробачить. Ні сьогодні. Ні завтра. Ніколи. І замість Прощеного буде Судний день». Звернення Президента України Володимира Зеленського.`,
