const source = [
  {
    id: 'jVt3cLR00Bg',
    name: 'Звернення Володимира Зеленського з нагоди Дня пам‘яті та примирення',
    translated: false,
    russianTimestamp: '',
    ...
    cities: ['Бородянка'],
    text: `
«Цьогоріч ми кажемо «Ніколи знову» інакше. Ми чуємо «Ніколи знову» інакше. Це звучить болісно, жорстоко. Без оклику, а зі знаком питання. Ви кажете: ніколи знову? Розкажіть про це Україні». Звернення Володимира Зеленського з нагоди Дня пам‘яті та примирення.
    `,
