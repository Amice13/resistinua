const source = [
  {
    id: 'I1dE4pEb7po',
    name: 'Збройні Сили України – це фундамент, на якому має стояти фортеця з нашої національної єдності',
    translated: false,
    russianTimestamp: '',
...
**Слава Україні!**
    `,
    description: 'Якими б жорстокими не були битви, у смерті немає шансів перемогти життя. Це знає кожна людина. Це знає кожен християнин. Це базовий елемент нашої культури.',
