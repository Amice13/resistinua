...
const text = `
Рекомендації із психологічної, гуманітарної допомоги, валіз для евакуації та інші важливі поради у телеграм-боті Готовий до всього @Hotovyi_do_vsioho_bot
`
